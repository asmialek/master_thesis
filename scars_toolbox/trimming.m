...
%
% Generated on: 22-Jul-2020 20:00:35
...
% State (3) - scars_model_new/Environment/Forces Environment/Subsystem/Spherical Harmonic Gravity Model1/sin(m_lon) & cos(m_lon)/For Iterator Subsystem/Unit Delay1
opspec.States(3).x = [1;-0.2036;-0.9171;0.57703;0.68213;-0.85479;-0.33407;0.99082;-0.069391;-0.96257;0.46134;0.77471;-0.7768;-0.4584;0.96346;0.066089;-0.99037;0.33718;0.85307;-0.68455;-0.57433;0.91841;0.20036;-0.99999;0.20684;0.91577;-0.57973;-0.67971;0.85651;0.33094;-0.99126;0.072693;0.96166;-0.46428;-0.77261;0.77888;0.45546;-0.96434;-0.062785;0.98991;-0.3403;-0.85134;0.68696;0.57161;-0.91972;-0.19711;0.99998;-0.21007;-0.91444;0.58243;0.67728;-0.85821;-0.32782;0.9917;-0.075994;-0.96075;0.46721;0.77051;-0.78095;-0.45251;0.96521;0.059481;-0.98943;0.34341;0.8496;-0.68936;-0.56889;0.92101;0.19386;-0.99995;0.21331;0.91309;-0.58511;-0.67484;0.8599;0.32469;-0.99212;0.079294;0.95983;-0.47013;-0.76839;0.78302;0.44956;-0.96607;-0.056177;0.98895;-0.34652;-0.84785;0.69175;0.56617;-0.92229;-0.19062;0.99991;-0.21654;-0.91174;0.5878;0.67239;-0.86159;-0.32156;0.99253;-0.082593;-0.95889;0.47305;0.76627;-0.78507;-0.4466;0.96692;0.052872;-0.98845;0.34962;0.84609;-0.69414;-0.56344;0.92357;0.18737;-0.99986;0.21977;0.91037;-0.59047;-0.66994;0.86326];
...
% State (4) - scars_model_new/Satellite Dynamics/6DOF ECEF (Quaternion)/Calculate DCM & Euler Angles/q
opspec.States(4).x = [0.35822;0.63864;-0.5195;0.44038];

% State (5) - scars_model_new/Satellite Dynamics/6DOF ECEF (Quaternion)/Calculate Position in EI /p
opspec.States(5).x = [-1290870.3368;6207524.2214;2396159.597];
opspec.States(5).SteadyState = [false;false;false];

% State (6) - scars_model_new/Satellite Dynamics/6DOF ECEF (Quaternion)/Calculate Position in EI /p1
opspec.States(6).x = [-1290870.3368;6207524.2214;2396159.597];
opspec.States(6).SteadyState = [false;false;false];

% State (7) - scars_model_new/Satellite Dynamics/6DOF ECEF (Quaternion)/Calculate Velocity in Body Axes/ub,vb,wb
opspec.States(7).x = [5422.3953;4928.4334;0.00088764];
opspec.States(7).SteadyState = [false;false;false];

% State (8) - scars_model_new/Satellite Dynamics/6DOF ECEF (Quaternion)/Celestial Longitude of Greenwich/Integrator
% - Default model initial conditions are used to initialize optimization.
opspec.States(8).SteadyState = false;

% State (9) - scars_model_new/Satellite Dynamics/6DOF ECEF (Quaternion)/p,q,r
opspec.States(9).x = [0.0007947;-0.00080379;-0.00030224];
opspec.States(9).SteadyState = [false;false;false];

% State (10) - scars_model_new/Satellite Dynamics/Integrator
% - Default model initial conditions are used to initialize optimization.
opspec.States(10).SteadyState = [false;false;false];
