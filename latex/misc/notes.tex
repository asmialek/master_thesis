...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item For use for first Feasibility Study, or testing and comparison of different actuators
    ...
    \item Add methods of analysis of the control systems, ie. bode, pole plots 
