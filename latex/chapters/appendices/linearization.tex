\subsection{Model Linearization with Control System Toolbox}\label{app:linearization}
    ...
    \subsubsection*{Step 2: Select input and output signals}
        ...
        \begin{figure}[H]
            \centering
            \subfloat[Open loop input setup]{{\includegraphics[width=0.97\textwidth]{appendix/input.png}\label{sub:lin_input} }}%
            % \qquad
            \\
            \subfloat[Open loop output setup]{{\includegraphics[width=0.97\textwidth]{appendix/output.png}\label{sub:lin_output} }}%
